...
1. Napravi novi **GitHub repo** i ubaci sadržaj `nutripilot/` foldera u njega.
   - Bez git‑a? Na GitHub‑u: „Add file → Upload files" pa prevučeš fajlove (uklj. folder `public/`).
